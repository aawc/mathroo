...
3.  **Permalinks**:
    ...
    - If the page is loaded with these parameters, it should automatically load the exact same 20 questions.
...
11. **Feedback**:
    - Highlight wrong answers upon submission.
    - Provide explanations for all questions via a toggle button.
